    ...
    translation: {
      ...
      settings: {
        ...
        accent: {
          ...
          netease: '网易红', spotify: 'Spotify 绿', applemusic: 'Apple Music 粉', skyblue: '天空蓝',
        },
    ...
    translation: {
      ...
      settings: {
        ...
        accent: {
          ...
          netease: 'NetEase Red', spotify: 'Spotify Green', applemusic: 'Apple Music Pink', skyblue: 'Sky Blue',
        },
