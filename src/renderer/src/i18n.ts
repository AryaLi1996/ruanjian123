...
const resources = {
  'zh-CN': {
    translation: {
      ...
      nav: { training: '模型训练', cover: '翻唱创作', audioTools: '音频工具', waveform: '数据准备', playback: '播放/监听', subscription: '订阅' },
      common: {
  ...
  'en-US': {
    translation: {
      ...
      nav: { training: 'Model Training', cover: 'Cover Creation', audioTools: 'Audio Tools', waveform: 'Data Preparation', playback: 'Playback / Monitor', subscription: 'Subscription' },
